...
Computations done at each node are completely independent and don’t write on the same memory block, which lead me not to use measures for avoiding race condition such as mutex object.
